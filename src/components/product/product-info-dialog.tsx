    ...
    <Dialog open={open} onOpenChange={(open) => setOpen(open)}>
      ...
      >
        ...
        <div className="grid min-h-[600px] w-full gap-0 overflow-hidden rounded-lg lg:grid-cols-2">
          ...
          <div className="flex flex-col bg-card p-8 lg:col-span-1">
            <div className="flex flex-1 items-center justify-center">
              <div className="w-full max-w-md rounded-lg bg-card/80 p-8 text-center backdrop-blur-sm">
                {product.image_url ? (
                  <img
                  ...
                  <div className="mx-auto mb-6 flex h-48 w-48 items-center justify-center rounded-lg bg-primary/20">
                    <ShoppingCartIcon className="h-24 w-24 text-primary" />
                  </div>
                )}
          ...
          <div className="flex flex-col overflow-y-auto bg-card p-6 lg:col-span-1">
            ...
            <div className="mt-4 border-border border-t pt-4">
              ...
              <Button
                onClick={onAddToCart}
                className="w-full bg-gradient-to-r from-primary to-accent py-2 font-semibold text-base text-primary-foreground hover:opacity-95"
                size="lg"
                tabIndex={0}
              >
